...
public static class MauiProgram
{
    public static MauiApp CreateMauiApp()
    {
        ...
        builder.Services.AddTransient<LeaveRequestFormPage>();
        builder.Services.AddTransient<LeaveRequestFormViewModel>();
        builder.Services.AddTransient<ShiftSwapFormPage>();
        builder.Services.AddTransient<ShiftSwapFormViewModel>();
        builder.Services.AddTransient<BulkAssignPage>();
        builder.Services.AddTransient<BulkAssignViewModel>();
        builder.Services.AddTransient<ApplyPatternPage>();
        builder.Services.AddTransient<ApplyPatternViewModel>();
        builder.Services.AddTransient<RosterHistoryPage>();
        builder.Services.AddTransient<RosterHistoryViewModel>();
